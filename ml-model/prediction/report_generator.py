...
# -----------------------------------
def compute_lesion_statistics(mask_path):
...
def generate_report(
    ...
    # Lesion Statistics
    # -----------------------------------
    lesion_count, avg_size, max_size = (
        compute_lesion_statistics(mask_image)
    )
    ...
    c.drawCentredString(
        width / 2,
        y,
        "AI MRI Lesion Detection System"
    )
    ...
    try:
        ...
        image_exists = (
            os.path.exists(mri_image)
            and os.path.exists(mask_image)
            and os.path.exists(overlay_image)
        )
        ...
        if image_exists:
            ...
            c.drawCentredString(
                width / 2,
                y,
                "Visualization images not available"
            )
